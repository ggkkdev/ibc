...
const EthereumClientType = "ethereum-client"
...
const deployCore = async (deployer) => {
    ...
    await deployer.deploy(EthereumClient, IBCHandler.address);
};
...
const init = async (deployer) => {
    ...
    for (const promise of [
        ...
        () => ibcHandler.registerClient(EthereumClientType, EthereumClient.address),
    ]) {
